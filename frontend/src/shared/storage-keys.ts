export const STORAGE_KEYS = {
  ...
  trainerShowBestArrow: 'blunder-tutor-show-best-arrow',
  trainerShowEngineBestArrow: 'blunder-tutor-show-engine-best-arrow',
  trainerShowBlunderArrow: 'blunder-tutor-show-blunder-arrow',
